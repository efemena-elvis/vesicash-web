  ...
  >
    ...
    <template slot="modal-cover-header">
      <div class="modal-cover-header">
        <div class="modal-cover-title h5-text text-center mgt-20">
          Enter OTP code
        </div>

        <div class="description-text text-center grey-700 mgt-12">
          OTP code sent to
          <b>{{ getUserEmail }}</b>
          to process a transfer of
          <b>
            {{ getTransferAmount }}
          </b>
        </div>
